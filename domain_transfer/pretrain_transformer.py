...
transform_params = [ tw0, tw1, tg1, tb1, tw2, tg2, tb2, tw3, tg3, tb3, tw4, tg4, tb4, tw5, tg5, tb5,
        tw5d, tg5d, tb5d, tw4d, tg4d, tb4d, tw3d, tg3d, tb3d, tw2d, tg2d, tb2d, tw1d ]
def transformer( IS, w0, w1, g1, b1, w2, g2, b2, w3, g3, b3, w4, g4, b4, w5, g5, b5,
...
IS = T.tensor4(  )
IT = T.tensor4(  )
IT_hat = transformer( IS, *transform_params )
...
print 'COMPILING'
t = time(  )
_train_t = theano.function( [ IS, IT ], cost, updates = t_updates )
_transform = theano.function( [ IS ], IT_hat )
...
for epoch in range( niter ):
    ...
    if n_epochs in [ 1, 2, 3, 4, 5, 10, 15, 20, 25 ]:
        joblib.dump( [ p.get_value(  ) for p in transform_params ],
                'models/%s/%d_transform_params.jl'%( desc, n_epochs ) )
